...
const criarItemDeAtividade = (atividade) => {
  ...
  // ${} realiza a interpolação dos dados entre as variaves definidas utilizando o objeto.item correspondente 

  const atualizaListaDeAtividade = () => {
  const section = document.querySelector('section')
    section.innerHTML = ''
 

  // Verificar se minha lista esta vazia '==' verifica se o lado direito e igual ao direito resultando em verdadeiro ou falso (bolean) 
